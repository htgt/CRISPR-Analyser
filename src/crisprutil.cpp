...
ots_data_t CrisprUtil::off_targets_by_seq(std::string seq, bool pam_right) {
 ...
 * 3) return the first ots data structure
 * 4) check that the query crispr sequence length is 20 bases
 *
 *
 */
